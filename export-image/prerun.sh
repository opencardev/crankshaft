...
IMG_FILE="${STAGE_WORK_DIR}/${IMG_FILENAME:?"ERROR"}${IMG_SUFFIX}.img"
...
BOOT_SIZE=33554432 # set boot size to 32MB which results in 64MB boot partition
...
IMG_SIZE=$(((BOOT_SIZE + TOTAL_SIZE + (512 * 1024 * 1024) + ROUND_SIZE - 1) / ROUND_SIZE * ROUND_SIZE))
